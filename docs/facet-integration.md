...
- Facet's committed Crystal 1.21 runtime macro corpus captures all 1,017
  ...
  for 864/900 portable contracts, including all 371 self-contained contracts.
  ...
  expressions, and yields, including immutable returned collections, range
  iteration, and boolean operands.
  ...
  provide the same views. The remaining 36
